...
async function sendEmail(email: string, link: string) {
  let transporter = nodemailer.createTransport({
    ...
    service: "gmail",
    host: "smtp.gmail.com",
    auth: { user: process.env.EMAIL, pass: process.env.GMAIL_APP_PASS },
  });
              ...
              >
                ...
                <tr>
                  <td style="text-align: center;">
                    <a href="https://ui-lib.com" title="logo" target="_blank">
                      <img
                        width="60"
                        src="https://ui-lib.com/wp-content/uploads/2018/11/Final_Web-01.png"
                        title="logo"
                        alt="logo"
                      />
                    </a>
